...
def dataset_card(labels: int, games: int, fingerprint: str) -> str:
    return "\n".join(
        [
            ...
            "time by a different model, and over 1,029 claims read twice the two agree on the",
            "subject 87% of the time (Cohen's kappa 0.85) and on polarity 93% (kappa 0.89). They",
            "agree far less about whether a claim is contested (kappa 0.42), which is a fact",
